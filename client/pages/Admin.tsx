...
import { getFinancingRequests, updateRequestStatus, deleteFinancingRequest, updateEvaluacionComercial, calculateScoring, type FinancingRequest, type EvaluacionComercial } from "@/lib/financingRequestManager";
